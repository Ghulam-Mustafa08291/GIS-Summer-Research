...
\item Supports climate-informed decision-making in agriculture, water management, and disaster preparedness.
\end{highlights}
...
The applications employ two complementary approaches for anomaly detection:
