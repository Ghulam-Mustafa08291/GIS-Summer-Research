...
\begin{enumerate}
    \item \textbf{Lack of Short-Term Operational Forecast Analysis:} While ICIMOD DroughtPK provides 9-month seasonal forecast outlooks and PMD offers monthly district-level anomaly maps, no existing Pakistan-focused tool enables users to compare short-term (16-day) GFS weather forecasts with historical climatological baselines. Although GFS 16-day rainfall forecasts have been validated for agricultural advisory in Pakistan \cite{bhatti2022gfs}, no interactive tool enables district-level comparison of these forecasts with historical climatological baselines across all districts of Pakistan. This short-term operational capability is essential for immediate early warning and proactive decision-making in agriculture, water management, and disaster preparedness where weekly-scale forecasts are actionable.
